 ...
 */
class UserPhotosSorted extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
    ...
    return (
      <Box className={classes.sectionContainer}>
        ...
        {userPhotos.length === 0 ? <Box className={classes.noPhotosMessageBox}>
          ...
          checked={true}/>
          {
            userPhotos.sort((a, b) => b.likes.length - a.likes.length || b.date_time - a.date_time).map((x) => (
...
export default withStyles(styles)(UserPhotosSorted);
